...
@FunctionalInterface
public interface A {
    /*// ✅ VALID - nested private interface inside class (allowed from Java 9)
    class OuterClass {
        private interface InnerFunction {
            void doWork();  ye dusre class me likh skate hai as example
        }*/
    public void m1();  // abstract

    static void m2() {
        System.out.println("Static Method from interface");//calling from Inteface name A.m2() beacuse it static we
        //we cant overriiden
