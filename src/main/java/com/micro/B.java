package com.micro;
@FunctionalInterface
public interface B { // if you extend interface in main class it will not work it waste of time
  ...
  //  public void simpleMethod();// only one method allowed coile time it nto give erro
   ...
   // ❌ This is illegal:
      ...
      /*  final void show(){ // ❌ Compile-time error *
      not allowed
    }*/
    ...
    static void m2() {
        System.out.println("Static Method from interface");//calling from Inteface name B.m2() beacuse it static we
        //we cant overriiden
