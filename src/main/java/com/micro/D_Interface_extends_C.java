...
// 🟢 Child Interface extending C_interface
public interface D_Interface_extends_C extends C_interface {
    // No new methods
    // Just inherits from C_interface
    // no need to write below method if you have some different login or code then you can write it
    //it ALREADY inherite the property of C
